...
$guestbookurl = "http://openwaygroup.com/guest/guestbook.html";
$guestbookreal = "/www/openwaygroup/guest/guestbook.html";
$guestlog = "/www/openwaygroup/guest/guestlog.html";
$cgiurl = "http://openwaygroup.com/cgi-openwaygroup/guestbook.pl";
...
sub no_redirection {
   ...
   elsif ( $why eq 'invalid_name' ) {
      $title = 'Invalid Name';
      $heading = 'You cannot spam from here';
      $text = 'Nice try, but you cannot use the name input to spam from here.';
      $comments_field = '';
   }
   else {
      print "$FORM{'realname'}";
